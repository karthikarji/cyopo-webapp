        ...
        <div className='flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12'>
          ...
          <div className='flex-1 max-w-2xl'>
            ...
            <div className='flex flex-wrap items-center gap-3 mb-8'>
              {hasResume && (
                <a
                  ...
                  download
                  className='inline-flex items-center gap-2 px-5 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-700 transition-colors shadow-sm'>
                  <Download size={14} />
                  Download Resume
                </a>
              )}
            ...
            {profile.socialMedia.map((link, i) => (
              <a
                ...
                rel='noopener noreferrer'
                title={link.platform}
                className='w-9 h-9 rounded-xl bg-gray-100 hover:bg-gray-900 hover:text-white flex items-center justify-center transition-all duration-200 text-gray-500'>
          ...
          <div className='flex-shrink-0'>
            <div className='relative'>
              ...
              <div className='absolute inset-0 bg-gradient-to-br from-violet-100 to-blue-100 rounded-3xl rotate-3 scale-105' />
              <div className='relative w-64 h-64 lg:w-80 lg:h-80 rounded-3xl overflow-hidden shadow-2xl'>
                {profile?.profilePhoto ? (
                  <img src={profile.profilePhoto} alt={profile.name} className='w-full h-full object-cover' />
                ) : (
                  <div className='w-full h-full bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center text-white text-7xl font-bold'>
