    ...
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='flex flex-col divide-y divide-white/5'>
        {experiences.map((exp, i) => (
          <div key={exp.id ?? i} className='grid grid-cols-[180px_1fr_320px] items-center gap-6 py-6 group'>
            {/* Year range — fixed left column */}
            ...
            {/* Role + company — fixed right column */}
            <div className='text-right'>
              <p className='font-black uppercase text-white text-lg tracking-wide'>{exp.title}</p>
